...
Latest version currently is: v1.0.4
...
Solar 1.0.3 is so big of a jump, I had to add every feature in one .md file!
Click [here](solar_v1.0.3_features.md) to check it out!
